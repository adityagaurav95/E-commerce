    ...
    <div>
      ...
      <div id="loginBox">
        ...
        >
          ...
          <span><Button className='ButtonDiv' variant="contained" onClick={() => handleAdd()} id="login">Login</Button></span>
          <span><Button  className='ButtonDiv' variant="contained" onClick={() => { navigate("/register") }} id="register">Register</Button></span><br />
