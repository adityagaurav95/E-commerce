    ...
    <div>
      ...
      <div id="registerBox">
        ...
        >
          ...
          <span><Button className='ButtonDiv' variant="contained" onClick={() => handleRegister()} id="register">Register</Button></span>
          <span><Button className='ButtonDiv' variant="contained" onClick={() => { navigate("/login") }} id="login">Login</Button></span><br />
